    ...
    <div class="container mt-6">
      ...
      <div class="row">
        ...
        <div class="v-image__image v-image__image--cover">
          <v-img src="@/assets/inspiration.jpg" aspect-ratio="1.5" alt="College Buddy Inspiration"></v-img>
        </div>
         ...
         <div class="col-md-5 offset-md-1 col-12">
          <h2 class="mb-4 headline">"Harder you work for something, greater you'll feel when achieve it."</h2>
          ...
          <p class="subtitle-1">We have started our journey and we will never stop to serve students community. Be ready, to be a part of change that will bring revolution to your college life.</p>
