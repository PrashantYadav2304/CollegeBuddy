<template>
  <section class="blue-grey lighten-4">
    <div class="container  py-10">
      <div class="display-1 black--text text-center mt-4">OUR MISSION</div>
        <hr class="mx-auto primary" width="200px">
          <p class=" text-center pt-5 pb-10">"To make your college life more productive."</p>
      <div class="row">
        <div class="col-md-5 col-12">
          <h2 class="mb-4 headline">"College life is the most precious time to grow  &amp; nurture yourself" </h2>
        ...
        <div class="v-image__image v-image__image--cover">
          <v-img src="@/assets/team.jpg" aspect-ratio="1.5" alt="College Buddy Mission"></v-img>
        </div>
