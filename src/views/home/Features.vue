      ...
      <v-container class="fill-height px-4 py-12">
        ...
        >
          ...
          <div class="container text-center">
            ...
            <p>We work hard to find better ways to save your time and money. We are creating a community with learning opportunities and better education that is driven by students itself.
            ...
            <div class="row">
              <div class="col-md-3 col-12">
                <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1"> Collaborate with people on projects, ideas, visions, challanges, fun activities and learn together with student community.  
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-12">
                <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1"> Checkout global events for great opportunities and explore yourself beyond college for a better learning experience.  
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-12">
                <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1">Know about campus events and participate, set reminder, participate in club activities and bring fun to life.  
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-12">
                <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1"> Update your attendance and stop worrying, Be free and bunk classes if there is something more important for you.  
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-12">
               ...
               <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1">Stop running, Just upload your files, documents or notes and get your prints delivered at doorstep within hours.
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3 col-12">
                <div class="py-12 px-4 v-card v-card--flat v-sheet blue lighten-3 rounded-xl">
                  ...
                  <div class="v-card__text subtitle-1">Buy notebooks, files, pen &amp; pencils, sheets and chartpapers and other stationery items online. Get within hours.
                  </div>
                </div>
              </div>
